...
import { CheckIcon, ErrorCrossIcon, InfoCircleIcon } from '../components/common/Icons';
      ...
      <ToastContainer>
        {toasts.map((toast) => (
          <ToastItem key={toast.id} type={toast.type}>
            ...
            {toast.type === 'error' && <ErrorCrossIcon width={18} height={18} />}
            {toast.type === 'info' && <InfoCircleIcon width={18} height={18} />}
